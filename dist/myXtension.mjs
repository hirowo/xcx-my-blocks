...
var en$1 = {
	"myXtension.entry.name": "My Extension",
	"myXtension.entry.description": "Description of this extension"
};
var ja$1 = {
	"myXtension.entry.name": "My Extension",
	"myXtension.entry.description": "拡張機能の説明"
};
var translations$1 = {
	en: en$1,
	ja: ja$1,
	"ja-Hira": {
	"myXtension.entry.name": "My Extension",
	"myXtension.entry.description": "かくちょうきのうのせつめい"
}
};
...
var en = {
	"myXtension.name": "My Extension",
	"myXtension.doIt": "do it [SCRIPT]"
};
var ja = {
	"myXtension.name": "My Extension",
	"myXtension.doIt": "[SCRIPT] を実行する"
};
var translations = {
	en: en,
	ja: ja,
	"ja-Hira": {
	"myXtension.name": "My Extension",
	"myXtension.doIt": "[SCRIPT] をじっこうする"
}
};
 ...
 * @type {string}
 */
var extensionURL = 'https://hirowo.github.io/xcx-my-extension/dist/myXtension.mjs';
...
var ExtensionBlocks = /*#__PURE__*/function () {
  ...
  return _createClass$1(ExtensionBlocks, [{
    ...
    value: function playTone(args) {
      ...
      oscillator.frequency.value = Cast$1.toNumber(args.FREQ);
      oscillator.start();
    ...
    key: "selectPort",
    value: function selectPort(args) {
      var _this2 = this;
    ...
    key: "sendToPort",
    value: function sendToPort(args) {
      if (this.selectedPort && this.selectedPort.isOpen) {
        this.selectedPort.write(args.MESSAGE, function (err) {
          if (err) {
    ...
    key: "getPortsMenu",
    value: function () {
      var _getPortsMenu = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
        var ports;
      ...
      function getPortsMenu() {
        return _getPortsMenu.apply(this, arguments);
      }
      return getPortsMenu;
    }()
  }], [{
